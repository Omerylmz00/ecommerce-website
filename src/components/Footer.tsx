...
export default function Footer() {
  return (
    <footer className="bg-gray-100 text-gray-800 mt-20 pt-12 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-start md:items-stretch">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-gray-600">
              Parametrik mobilya tasarımlarında estetiği ve işlevselliği bir araya getiriyoruz.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2 justify-start items-start h-full">
            ...
            <p className="text-sm text-gray-600">Yeni koleksiyonlardan ve indirimlerden ilk sen haberdar ol.</p>
      ...
      <div className="border-t border-gray-200 mt-10 pt-4 text-center text-sm text-gray-500">
        © {new Date().getFullYear()} Barida Lumion. Tüm hakları saklıdır. | <a href="#" className="hover:underline">Gizlilik</a> | <a href="#" className="hover:underline">Şartlar</a>
      </div>
    </footer>
  );
}